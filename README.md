...
- **SQL**: Jointure, CTEs, Fonctions de fenêtre, Fonctions d'agrégation
- **Python**: Pandas, NumPy, Seaborn, Matplotlib, Scikit-learn
- **Excel et Google Sheets**: Tableaux croisés dynamiques, VLOOKUP
- **Data Visualization**: Power BI (DAX, Tableaux de bord)
- **Machine Learning**: Modélisation prédictive, Classification & Régression
- **Communication**: Présentation claire des insights de données
---
### Let's Connect
